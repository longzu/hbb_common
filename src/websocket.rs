...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("127.0.0.1:65115"), "ws://127.0.0.1:21118");
        assert_eq!(check_ws("127.0.0.1:65116"), "ws://127.0.0.1:21118");
        assert_eq!(check_ws("127.0.0.1:65117"), "ws://127.0.0.1:21119");
        assert_eq!(check_ws("rustdesk.com:65115"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:65116"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:65117"), "ws://rustdesk.com/ws/relay");
        ...
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:65115"),
            "ws://[0:0:0:0:0:0:0:1]:21118"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:65116"),
            "ws://[0:0:0:0:0:0:0:1]:21118"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:65117"),
            "ws://[0:0:0:0:0:0:0:1]:21119"
        );
        assert_eq!(check_ws("rustdesk.com:65115"), "wss://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:65116"), "wss://rustdesk.com/ws/id");
        assert_eq!(
            check_ws("rustdesk.com:65117"),
            "wss://rustdesk.com/ws/relay"
        );
        // set relay-server with default port
        Config::set_option("relay-server".to_string(), "127.0.0.1:65117".to_string());
        assert_eq!(check_ws("127.0.0.1:65115"), "ws://127.0.0.1:21118");
        assert_eq!(check_ws("127.0.0.1:65116"), "ws://127.0.0.1:21118");
        assert_eq!(check_ws("127.0.0.1:65117"), "ws://127.0.0.1:21119");
